...
class FrontContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'bonjour', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : ($this->services['annotation_reader'] = new \Doctrine\Common\Annotations\AnnotationReader())) && false ?: '_'}, [0 => 'C:\\xampp\\htdocs\\digital1769\\modules\\ps_checkout\\src\\Entity']);
        $c->addExcludePaths([0 => 'C:\\xampp\\htdocs\\digital1769\\modules\\ps_checkout\\src\\Entity/index.php']);
        ...
        $a->setProxyDir('C:\\xampp\\htdocs\\digital1769/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_eeae5c4cbefd39cad36d34d273a2ab18bfa366f05392da5fb0f15ae3bbb7bd2b');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\xampp\\htdocs\\digital1769/var/cache/prod\\/localization');
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.6.9', 'C:\\xampp\\htdocs\\digital1769');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => 'C:\\xampp\\htdocs\\digital1769/app/',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'C:\\xampp\\htdocs\\digital1769/var/cache/prod/',
            ...
            'ps_cache_dir' => 'C:\\xampp\\htdocs\\digital1769/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp\\htdocs\\digital1769/var/cache/prod//doctrine/orm/Proxies',
